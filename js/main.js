$(document).ready(function() {
    ...
    uniqueContainerForToggleButton(); // this is the function that creates the container and the toggle button to retrieve the dot navigation bar
    ...
    collapsingElement();
    var $toggleHandlerMainContainer = $('.consolidated-elements');
